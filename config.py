...
# Vanilla PPO configurations for different seeds
_CONFIG_vanilla_ppo_seed2 = {
    "algorithm": "PPO",
    "algorithm_params": algorithm_params["PPO"],
    "state": states["5"],
    "action_smoothing": 0.75,
...
CONFIGS = {
    ...
    "Chen": _CONFIG_Chen,
    "ASAP": _CONFIG_ASAP,
    "vanilla_ppo_seed2": _CONFIG_vanilla_ppo_seed2,
    "vanilla_ppo_seed3": _CONFIG_vanilla_ppo_seed3,
}
